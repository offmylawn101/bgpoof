    ...
    <div className="site-shell">
      ...
      <main className="about-page">
        <nav className="breadcrumbs" aria-label="Breadcrumb">
          ...
          <span aria-current="page">About, privacy & licenses</span>
        </nav>
        <h1>Your photos stay yours.</h1>
        <p>
          BG Poof removes photo backgrounds without accounts, watermarks, or
          paid download tiers. Your browser uploads your photo, resized when
          needed, to Cloudflare for background removal. When automatic
          refinement is enabled, our processing server also receives that upload
          and its mask. BG Poof does not store your photos.
        </p>
        <h2>How it works</h2>
        <p>
          Your browser keeps the original photo to create the final download.
          PNGs within 1,536 pixels per side and 2 MiB are uploaded unchanged;
          other photos are resized and compressed before upload. Cloudflare
          Images identifies the subject. Our server then automatically refines
          edge transparency and reduces background color around those edges when
        ...
        <p>
          ...
          can replace them, clear the result, or close the page when you are
          done.
        </p>
        <h2>Analytics</h2>
        {analyticsId ? (
          <p>
            ...
            uses cookies and collects information about page visits, browser and
            device details, and site interactions.{' '}
        ...
        <p>
          ...
          ready within five seconds, but connection speed, image size, and
          service load affect the wait. Fine hair, glass, shadows, and busy
          backgrounds can need additional editing; results will differ from
          remove.bg.
        </p>
        <h2>Credits</h2>
        <p>
        ...
        <p>
          ...
          , used under the{' '}
          <a href="https://unsplash.com/license">Unsplash License</a>. Its
          example cutout was processed with Cloudflare Images and this site’s
          browser compositing.
        </p>
        <p>
